...
import 'package:linkedin_clone/Widgets/button.dart';
...
class PostCard extends StatefulWidget {
  var snap;
  var usersnap;
  PostCard({super.key, required this.snap, required this.usersnap});
        ...
        Row(
          ...
          children: [
            ...
            InkWell(
                ...
                child: const ButtonLogo(
                    icon: Icon(Icons.comment), text: 'Comment')),
            const ButtonLogo(icon: Icon(Icons.share), text: 'Share'),
            const ButtonLogo(icon: Icon(Icons.send), text: 'Send'),
          ],
        ),
        Container(
